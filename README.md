...
> *This project is developed during my spare time, along side my lead dev position at [maif](http://www.maif.fr), and aims to provide a competitive replacement solution to our current ETL stack.*
